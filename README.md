...
1. Clone the repository:
   ```bash
   git clone https://github.com/Fayaz-unas/portfolio.git
   ```
...
├── App.jsx           # Main Application logic & Scroll Engine
...
- **Email**: [fayazunas@gmail.com](mailto:fayazunas@gmail.com)
- **LinkedIn**: [linkedin.com/in/fayaz-unas](https://linkedin.com/in/fayaz-unas)
