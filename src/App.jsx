  ...
  return (
    <div className="relative bg-white font-body antialiased">
      ...
      <footer className="bg-black text-white py-12 lg:py-16 px-4 md:px-8 lg:px-12 border-t-[12px] border-black overflow-hidden relative z-20">
        ...
        <div className="absolute top-0 right-0 w-[40vw] h-[40vw] bg-primary/8 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2" />
        <div className="absolute bottom-0 left-0 w-[30vw] h-[30vw] bg-secondary/8 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2" />
        ...
        <div className="w-full flex flex-col gap-12 md:gap-16 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-16">
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <nav className="flex flex-col gap-4 font-black text-base md:text-lg uppercase tracking-widest text-white/60">
                ...
                <a href="mailto:fayazunas96@gmail.com" className="hover:text-secondary transition-all hover:translate-x-3 inline-block">MAIL_TERMINAL</a>
              </nav>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 pt-10 border-t-2 border-white/5 opacity-30">
            <span className="text-[9px] font-black uppercase tracking-[0.5em]">© 2026 FAYAZ UNAS — ENGINEERED WITH PRECISION</span>
          </div>
        </div>
      </footer>
    </div>
